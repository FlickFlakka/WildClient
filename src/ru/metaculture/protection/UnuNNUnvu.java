...
public final class UnuNNUnvu
implements AutoCloseable {
    private static final UnuNNUnvu primaryVal = new UnuNNUnvu();
    private static final String secondaryVal = "assets/wild/shaders/mainmenu/menu_quad.vert";
    private static final String tertiaryVal = "assets/wild/shaders/mainmenu/midnight_azure.frag";
    ...
    public static UnuNNUnvu primaryVal() {
        return primaryVal;
    }
    ...
    public void primaryVal(int n, int n2, float f, float f2, ThemePalette configVal, float f3) {
        ...
        try {
            ...
            int n3 = configVal == null ? -16715521 : configVal.depthVal();
            int n4 = configVal == null ? -16759553 : configVal.descRef();
            this.paramVal.primaryVal("uAccentTop", this.secondaryVal(n3, 16), this.secondaryVal(n3, 8), this.secondaryVal(n3, 0));
            this.paramVal.primaryVal("uAccentBottom", this.secondaryVal(n4, 16), this.secondaryVal(n4, 8), this.secondaryVal(n4, 0));
            this.paramVal.primaryVal("uActivity", 1.0f);
            this.paramVal.primaryVal("uAlpha", this.primaryVal(f3));
            this.paramVal.primaryVal("uLightMode", 0.0f);
            for (int i = 0; i < 14; ++i) {
    ...
    private void secondaryVal() {
        ...
        if (this.paramVal == null) {
            this.paramVal = this.marginVal.primaryVal("midnight_azure_click_gui", secondaryVal, tertiaryVal);
        }
    }
