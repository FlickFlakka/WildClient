...
public final class MainMenuShaderBackground
implements AutoCloseable {
    private static final MainMenuShaderBackground primaryVal = new MainMenuShaderBackground();
    private static final String secondaryVal = "assets/wild/shaders/mainmenu/menu_quad.vert";
    private static final String tertiaryVal = "assets/wild/shaders/mainmenu/porcelain_dawn.frag";
    ...
    public static MainMenuShaderBackground primaryVal() {
        return primaryVal;
    }
    ...
    public void primaryVal(int n, int n2, float f, float f2, ThemePalette configVal, float f3) {
        ...
        try {
            ...
            int n3 = configVal == null ? -9816 : configVal.depthVal();
            int n4 = configVal == null ? -19589 : configVal.descRef();
            ...
            this.paramVal.primaryVal("uAlpha", this.primaryVal(f3) * 0.85f);
    ...
    private void secondaryVal() {
        ...
        if (this.paramVal == null) {
            this.paramVal = this.marginVal.primaryVal("porcelain_dawn_click_gui", secondaryVal, tertiaryVal);
        }
    }
