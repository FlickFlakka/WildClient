...
public enum UuNVnuUvunN {
    ...
    private static final Map<Integer, UuNVnuUvunN> tertiaryVal;
    private static final Map<String, UuNVnuUvunN> marginVal;

    static {
        HashMap<Integer, UuNVnuUvunN> hashMap = new HashMap<Integer, UuNVnuUvunN>();
        HashMap<String, UuNVnuUvunN> hashMap2 = new HashMap<String, UuNVnuUvunN>();
        for (UuNVnuUvunN sackF : UuNVnuUvunN.values()) {
            hashMap.put(sackF.secondaryVal, sackF);
            hashMap2.put(sackF.primaryVal.toLowerCase(), sackF);
        }
        tertiaryVal = hashMap;
        marginVal = hashMap2;
    }
    ...
    public static String primaryVal(int n) {
        ...
        UuNVnuUvunN sackF = tertiaryVal.getOrDefault(n, KEY_NONE);
        return sackF.primaryVal;
    }

    public static int primaryVal(String string) {
        UuNVnuUvunN sackF = marginVal.getOrDefault(string.toLowerCase(), KEY_NONE);
        return sackF.secondaryVal;
    }

    public static UuNVnuUvunN secondaryVal(int n) {
        return tertiaryVal.getOrDefault(n, KEY_NONE);
    }

    public boolean tertiaryVal(int n) {
        return n == this.secondaryVal();
    }
    ...
    @Generated
    private UuNVnuUvunN(String string2, int n2) {
