...
public final class GlacierVeilMenuBackground
implements AutoCloseable {
    private static final GlacierVeilMenuBackground primaryVal = new GlacierVeilMenuBackground();
    private static final String secondaryVal = "assets/wild/shaders/mainmenu/menu_quad.vert";
    private static final String tertiaryVal = "assets/wild/shaders/mainmenu/glacier_veil.frag";
    ...
    public static GlacierVeilMenuBackground primaryVal() {
        return primaryVal;
    }
    ...
    public void primaryVal(int n, int n2, float f, float f2, ThemePalette configVal, float f3) {
        ...
        try {
            ...
            int n3 = configVal == null ? -5706497 : configVal.depthVal();
            int n4 = configVal == null ? -12681729 : configVal.descRef();
    ...
    private void primaryVal(float f, float f2, long l) {
        ...
        block5: {
            block4: {
                ...
                f3 = (float)(l - this.limitVal) / 1.0E9f;
                this.limitVal = l;
                if (!Float.isFinite(f3)) break block4;
    ...
    private void secondaryVal() {
        ...
        if (this.paramVal == null) {
            this.paramVal = this.marginVal.primaryVal("glacier_veil_click_gui", secondaryVal, tertiaryVal);
        }
    }
