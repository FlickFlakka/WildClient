...
public final class UnNNUUUVUUvu
implements AutoCloseable {
    private static final UnNNUUUVUUvu primaryVal = new UnNNUUUVUUvu();
    private static final String secondaryVal = "assets/wild/shaders/mainmenu/menu_quad.vert";
    private static final String tertiaryVal = "assets/wild/shaders/mainmenu/velvet_dusk.frag";
    ...
    public static UnNNUUUVUUvu primaryVal() {
        return primaryVal;
    }
    ...
    public void primaryVal(int n, int n2, float f, float f2, ThemePalette configVal, float f3) {
        ...
        try {
            ...
            int n3 = configVal == null ? -6656769 : configVal.depthVal();
            int n4 = configVal == null ? -10802531 : configVal.descRef();
    ...
    private void secondaryVal() {
        ...
        if (this.paramVal == null) {
            this.paramVal = this.marginVal.primaryVal("velvet_dusk_click_gui", secondaryVal, tertiaryVal);
        }
    }
