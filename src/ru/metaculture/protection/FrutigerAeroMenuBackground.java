...
public final class FrutigerAeroMenuBackground implements AutoCloseable {
   private static final FrutigerAeroMenuBackground primaryVal = new FrutigerAeroMenuBackground();
   private static final String secondaryVal = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String tertiaryVal = "assets/wild/shaders/mainmenu/frutiger_aero.frag";
   ...
   public static FrutigerAeroMenuBackground primaryVal() {
      return primaryVal;
   }
   ...
   public void primaryVal(int var1, int var2, float var3, float var4, ThemePalette var5, float var6) {
      if (var1 > 0 && var2 > 0) {
         ...
         try {
            ...
            int var13 = var5 == null ? -8657678 : var5.depthVal();
            int var14 = var5 == null ? -13121888 : var5.descRef();
   ...
   private void secondaryVal() {
      ...
      if (this.paramVal == null) {
         this.paramVal = this.marginVal
            .primaryVal("frutiger_aero_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/frutiger_aero.frag");
      }
   }
