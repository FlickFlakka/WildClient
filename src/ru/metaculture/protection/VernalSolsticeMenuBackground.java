...
public final class VernalSolsticeMenuBackground
implements AutoCloseable {
    private static final VernalSolsticeMenuBackground primaryVal = new VernalSolsticeMenuBackground();
    private static final String secondaryVal = "assets/wild/shaders/mainmenu/menu_quad.vert";
    private static final String tertiaryVal = "assets/wild/shaders/mainmenu/vernal_solstice.frag";
    ...
    public static VernalSolsticeMenuBackground primaryVal() {
        return primaryVal;
    }
    ...
    public void primaryVal(int n, int n2, float f, float f2, ThemePalette configVal, float f3) {
        ...
        try {
            ...
            int n3 = configVal == null ? -13447886 : configVal.depthVal();
            int n4 = configVal == null ? -10496 : configVal.descRef();
            ...
            this.paramVal.primaryVal("uAlpha", this.primaryVal(f3) * 0.76f);
            this.paramVal.primaryVal("uLightMode", 1.0f);
            for (int i = 0; i < 14; ++i) {
    ...
    private void secondaryVal() {
        ...
        if (this.paramVal == null) {
            this.paramVal = this.marginVal.primaryVal("vernal_solstice_click_gui", secondaryVal, tertiaryVal);
        }
    }
